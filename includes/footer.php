                    ...
                    <div class="f-logo">
                        <ul class="footer-ul">
                            <li class="footer-li footer-logo">
                                <a href="index.php">
                                    <img class="img-fluid" src="image/LogoPHP2.png" alt="">
                                </a>
                            </li>
                            ...
                            <li class="footer-li footer-contact">
                                <ul class="f-ul-li-ul">
                                    ...
                                    <li class="footer-info">
                                        ...
                                        <a href="mailto:demo@demo.com">Email: tuananh.group@gmail.com</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="footer-li footer-address">
                ...
                <div class="col">
                    <ul class="f-bottom">
                        <li class="f-c f-copyright">
                            <p>Copyright <i class="fa fa-copyright"></i> DinhHuong</p>
                        </li>
