$(document).ready(function(){
 ...
 $('.profile-li .profile-link').on( "click", function() {

    $('.profile-li .profile-link').removeClass('active');
    ...
    //     var email = $("#email").val();
    //     var email_check = new RegExp('^[a-z0-9]+([-._][a-z0-9]+)*@([a-z0-9]+(-[a-z0-9]+)*\.)+[a-z]{1,5}$');

    //     // var password_confirm2 = $("#password_confirm2").val();

    //     //alert(password_confirm2);
    //     if(!email){
    //         $("#status_email").html('<strong style="color:green">Email emty</strong>');
    //     }

    //     if (email_check.test(email)) {

    //         $("#status_email").html('<strong style="color:green">Email match</strong>');

    //     } else {
    //         $("#status_email").html('<strong style="color:red">Email do not match</strong>');
    //     }
